	...
	<?php 
		...
		$query = "SELECT * FROM entrance_users WHERE regist_no = '{$reg}'";
...
<div id="overlay-content"> 
	<form action="results" method="post">
		<center>
	 <input style="margin-top:10%; padding:10px 20px" type="submit" class="btn-success" name="end_exam_time_btn" title="Click To Finally Submit Exam" value="Submit" />
		</center>
	</form>
</div>
			...
			<div class="padding-top-10 padding-bottom-10">
				<table width="90%" border="0" cellspacing="0" cellpadding="1">
				  <tr>
					...
					<td>Subject : General Knowledge </td>
	...
	<div class="panel">
		<div class="panel-heading">
			<?php  
				...
				@$quest = get_entrance_questions($subject, $class, $term, $q_no);
