	...
	function readURL(input) 
	{
		if (input.files && input.files[0]) 
		{
			...
			<?php include('layout/left-sidebar.php') ?>  	
				...
				<form action="upload.php?query=entrance" method="post" enctype="multipart/form-data">
		...
		<!-- MAIN CONTENT -->
			<div class="main-content">
				<div class="container-fluid">
					<form action="add-entrancestudents" method="post">
					...
					<?php
						$table_name = 'entrance_users';
						$total = get_number_of_rec($table_name);
						$total += 1;
						$dated = getdate();
						$stud_reg_id;
						@$stud_reg_id .= 'PRE-STUD-';
							...
							<div class="panel">
								<div class="panel-heading">
									...
									<!-- LOGICS TO CREATE UPDATE AND VIEW STUDENTS -->
										<?php
											$conn = db_connect();
											if(isset($_REQUEST['entr_stud_btn']))
											{							
												@$new_stud_msg = create_entr_new_student($new_stud_msg);
											...
											{		
												...
												@$upload_msg =  upload_entrance_student_photo($ses_reg_no, $ses_class, $ses_pix);
								...
								<div class="panel-body">
									<div class="input-group">
										...
										value="<?php  echo $stud_reg_id;  ?>" readonly required>
									</div>
									<br>
									...
									<div class="input-group pull-right">
										...
										<button type="submit" class="btn btn-primary" name="entr_stud_btn">Create Student</button>
									</div>
