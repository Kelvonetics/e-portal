	...
	<?php include('layout/top-head.php') ?>		           <?php confirm_staff_login();  ?>
					...
					<div class="panel panel-profile">
						<div class="clearfix">
							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="upload/<?php echo $_SESSION['photo'];  ?>" class="img-circle" width="65" alt="Avatar">
										<h3 class="name"><?php echo $_SESSION['lastname'].' '.$_SESSION['firstname'];  ?></h3>
										<span class="online-status status-available" ><?php echo $_SESSION['role'];  ?> </span>
									</div>
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<ul class="list-unstyled list-justify">
											<li>Join Date <span><?php echo $_SESSION['doj'];  ?></span></li>
							...
							<div class="profile-right">
								<h4 class="heading"><?php echo @$_SESSION['firstname']; ?>'s Awards</h4>
								<!-- AWARDS -->
								<div class="awards">
									<div class="row">
